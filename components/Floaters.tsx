...
export const Floaters: React.FC<FloatersProps> = ({
  ...
  brochureLink = '#',
  wazeLink = 'https://ul.waze.com/ul?place=ChIJOdKVKABn0DERt2WWLQEDDQ0&ll=1.91680090%2C103.17923850&navigate=yes&utm_campaign=default&utm_source=waze_website&utm_medium=lm_share_location',
}) => {
