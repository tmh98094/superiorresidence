      ...
      <div className="py-8 px-6">
        <div className="max-w-[1800px] mx-auto">
          <div className="flex flex-col md:flex-row items-center md:items-center gap-6 md:gap-8 text-center md:text-left">
            {/* Logo - 30% larger */}
            <div className="flex-shrink-0 h-[187px] w-[312px] overflow-hidden flex items-center justify-center">
              <img
                src="/images/logo1.png"
                alt="Superior Residences"
                className="h-[374px] w-auto object-contain"
              />
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-stone-400 flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                <span>Lot 101, Jalan Batu Pahat, Kampung Baru Ayer Hitam, 86100 Ayer Hitam, Johor Darul Ta'zim</span>
                <span className="hidden md:inline">|</span>
                <a href="tel:+60775829997" className="text-gold-accent hover:text-white transition-colors">
                  +607 758 2997
                </a>
                <span className="hidden md:inline">|</span>
                <a href="mailto:info@superiorpropertydevelopment.com.my" className="text-gold-accent hover:text-white transition-colors">
                  info@superiorpropertydevelopment.com.my
                </a>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-4 justify-center md:justify-start">
                  ...
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-stone-800 hover:bg-gold-accent flex items-center justify-center transition-colors group"
                  >
                    <Globe className="w-5 h-5 text-stone-400 group-hover:text-black" />
                  </a>
                </div>
              </div>
            </div>
